...
const HeroSection = () => {
  ...
  return (
    <section
      // 1. ADDED pt-28 (112px) and md:pt-32 here to push everything down below your navbar safely on all devices
      className="relative min-h-screen flex flex-col justify-between pt-28 md:pt-32 text-white bg-cover bg-center font-sans overflow-hidden"
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.82), rgba(0, 0, 0, 0.82)), url('/assets/images/hero-bg.jfif')`
      }}
    >
      
      {/* 2. REMOVED my-16 from this div, added pb-12 to give breathing room above the grid */}
